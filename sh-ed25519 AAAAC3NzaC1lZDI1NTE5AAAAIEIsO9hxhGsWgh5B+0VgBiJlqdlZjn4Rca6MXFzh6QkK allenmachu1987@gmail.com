...
[1mOPTIONS[0m
       ...
       <refspec>...
           ...
           omitted—such a push will update a ref that [1m<src> [22mnormally updates
           without any [1m<refspec> [22mon the command line. Otherwise, missing
           [1m:<dst> [22mmeans to update the same ref as the [1m<src>[22m.

           If <dst> doesn’t start with [1mrefs/ [22m(e.g.  [1mrefs/heads/master[22m) we will
           ...
           where in [1mrefs/* [22mthe <dst> reference lives as described in detail
           ...
           of [1mrefs/{tags,heads}/*[22m. In the case of tags and commits, these will
           be treated as if they were the commits inside [1mrefs/heads/* [22mfor the
           ...
           Tree and blob objects outside of [1mrefs/{tags,heads}/* [22mwill be
           treated the same way as if they were inside [1mrefs/tags/*[22m, any update
           ...
           [1m+ [22min the refspec (or [1m--force[22m), except when forbidden by
           configuration or hooks. See [1mreceive.denyDeletes [22min [1mgit-config[22m(1)
           and [1mpre-receive [22mand [1mupdate [22min [1mgithooks[22m(5).
       ...
       --all, --branches
           Push all branches (i.e. refs under [1mrefs/heads/[22m); cannot be used
           with other <refspec>.
       ...
       --mirror
           ...
           [1mrefs/remotes/[22m, and [1mrefs/tags/[22m) be mirrored to the remote
           repository. Newly created local refs will be pushed to the remote
           end, locally updated refs will be force updated on the remote end,
           and deleted refs will be removed from the remote end. This is the
           default if the configuration option [1mremote.<remote>.mirror [22mis set.
       ...
       --follow-tags
           ...
           also push annotated tags in [1mrefs/tags [22mthat are missing from the
           ...
           variable [1mpush.followTags[22m. For more information, see [1mpush.followTags[0m
           in [1mgit-config[22m(1).
       ...
       -o <option>, --push-option=<option>
           ...
           [1m--push-option=<option> [22mis given from the command line, the values
           of configuration variable [1mpush.pushOption [22mare used instead.
       ...
       --force-with-lease=<refname>:<expect>
           ...
           advance with their commit, and blindly pushing with [1m--force [22mwill
           lose their work.
           ...
           [1m--force-with-lease=<refname>[22m, without specifying the expected
           ...
           [1m--force-with-lease=<refname>:<expect> [22mthat specifies the expected
           ...
           interacts very badly with anything that implicitly runs [1mgit fetch[0m
           on the remote to be pushed to in the background, e.g.  [1mgit fetch[0m
           [1morigin [22mon your repository in a cronjob.
           ...
           Now when the background process runs [1mgit fetch origin [22mthe
           references on [1morigin-push [22mwon’t be updated, and thus commands like:

               git push --force-with-lease origin-push

           Will fail unless you manually run [1mgit fetch origin-push[22m. This
           method is of course entirely defeated by something that runs [1mgit[0m
           [1mfetch --all[22m, in that case you’d need to either disable it or do
           ...
           I.e. create a [1mbase [22mtag for versions of the upstream code that
           you’ve seen and are willing to overwrite, then rewrite history, and
           finally force push changes to [1mmaster [22mif the remote version is still
           at [1mbase[22m, regardless of what your local [1mremotes/origin/master [22mhas
           been updated to in the background.

           Alternatively, specifying [1m--force-if-includes [22mas an ancillary
           option along with [1m--force-with-lease[=<refname>] [22m(i.e., without
       ...
       -f, --force
           ...
           branch, use a [1m+ [22min front of the refspec to push (e.g [1mgit push[0m
           [1morigin +master [22mto force a push to the [1mmaster [22mbranch). See the
       ...
       -u, --set-upstream
           ...
           upstream (tracking) reference, used by argument-less [1mgit-pull[22m(1)
           and other commands. For more information, see [1mbranch.<name>.merge[0m
           in [1mgit-config[22m(1).
       ...
       --no-recurse-submodules, --recurse-submodules=check|on-demand|only|no
           ...
           If [4mcheck[24m is used Git will verify that all submodule commits that
           changed in the revisions to be pushed are available on at least one
           remote of the submodule. If any commits are missing the push will
           be aborted and exit with non-zero status. If [4mon-demand[24m is used all
           submodules that changed in the revisions to be pushed will be
           pushed. If on-demand was not able to push all necessary revisions
           it will also be aborted and exit with non-zero status. If [4monly[24m is
           used all submodules will be pushed while the superproject is left
           unpushed. A value of [4mno[24m or using [1m--no-recurse-submodules [22mcan be
       ...
       --[no-]verify
           Toggle the pre-push hook (see [1mgithooks[22m(5)). The default is
...
[1mGIT URLS[0m
       ...
       example the local path [1mfoo:bar [22mcould be specified as an absolute path
       ...
       former implies --local option. See [1mgit-clone[22m(1) for details.

       [4mgit[24m [4mclone[24m, [4mgit[24m [4mfetch[24m and [4mgit[24m [4mpull[24m, but not [4mgit[24m [4mpush[24m, will also accept a
       suitable bundle file. See [1mgit-bundle[22m(1).

       When Git doesn’t know how to handle a certain transport protocol, it
       attempts to use the [4mremote-<transport>[24m remote helper, if one exists. To
...
[1mREMOTES[0m
   ...
   [1mNamed file in $GIT_DIR/branches[0m
       ...
       if you don’t provide one on the command line. [1m<branch> [22mis the name of
...
[1mOUTPUT[0m
       ...
       summary
           ...
           [1mgit log [22m(this is [1m<old>..<new> [22min most cases, and [1m<old>...<new> [22mfor
           ...
           remote rejected
               ...
               [1mreceive.denyCurrentBranch [22m(for pushes to the checked out
               branch), [1mreceive.denyNonFastForwards [22m(for forced
               non-fast-forward updates), [1mreceive.denyDeletes [22mor
...
[1mEXAMPLES[0m
       [1mgit push[0m
           Works like [1mgit push <remote>[22m, where <remote> is the current
           branch’s remote (or [1morigin[22m, if no remote is configured for the
           current branch).
       ...
       [1mgit push origin[0m
           ...
           [1morigin [22muse [1mgit config remote.origin.push HEAD[22m. Any valid <refspec>
           (like the ones in the examples below) can be configured as the
           default for [1mgit push origin[22m.
       ...
       [1mgit push mothership master:satellite/master dev:satellite/dev[0m
           ...
           work done on [1msatellite[22m, and is often necessary when you can only
       ...
       [1mgit push origin +dev:master[0m
           ...
           removed by a [1mgit gc [22mcommand on the origin repository.
...
[1mCONFIGURATION[0m
       ...
       the [1mgit-config[22m(1) documentation. The content is the same as what’s
       found there:

       push.autoSetupRemote
           If set to "true" assume [1m--set-upstream [22mon default push when no
           upstream tracking exists for the current branch; this option takes
           effect with push.default options [4msimple[24m, [4mupstream[24m, and [4mcurrent[24m. It
           is useful if by default you want new branches to be pushed to the
           default remote (like the behavior of [4mpush.default=current[24m) and you
           also want the upstream tracking to be set. Workflows most likely to
           benefit from this option are [4msimple[24m central workflows where all
           branches are expected to have the same name on the remote.

       push.default
           Defines the action [1mgit push [22mshould take if no refspec is given
           ...
           destination), [1mupstream [22mis probably what you want. Possible values
           are:

           •   [1mnothing [22m- do not push anything (error out) unless a refspec is
               given. This is primarily meant for people who want to avoid
               mistakes by always being explicit.

           •   [1mcurrent [22m- push the current branch to update a branch with the
               same name on the receiving end. Works in both central and
               non-central workflows.

           •   [1mupstream [22m- push the current branch back to the branch whose
               changes are usually integrated into the current branch (which
               is called [1m@{upstream}[22m). This mode only makes sense if you are
               pushing to the same repository you would normally pull from
               (i.e. central workflow).

           •   [1mtracking [22m- This is a deprecated synonym for [1mupstream[22m.

           •   [1msimple [22m- push the current branch with the same name on the
               remote.

               If you are working on a centralized workflow (pushing to the
               same repository you pull from, which is typically [1morigin[22m), then
           ...
           •   [1mmatching [22m- push all branches having the same name on both ends.
               This makes the repository you are pushing to remember the set
               of branches that will be pushed out (e.g. if you always push
               [4mmaint[24m and [4mmaster[24m there and no other branches, the repository
               you push to will have these two branches, and your local [4mmaint[0m
               and [4mmaster[24m will be pushed there).

               To use this mode effectively, you have to make sure [4mall[24m the
               branches you would push out are ready to be pushed out before
               running [4mgit[24m [4mpush[24m, as the whole point of this mode is to allow
               ...
               This used to be the default, but not since Git 2.0 ([1msimple [22mis
               the new default).

       push.followTags
           If set to true, enable [1m--follow-tags [22moption by default. You may
           override this configuration at time of push by specifying
           [1m--no-follow-tags[22m.

       push.gpgSign
           May be set to a boolean value, or the string [4mif-asked[24m. A true value
           causes all pushes to be GPG signed, as if [1m--signed [22mis passed to
           [1mgit-push[22m(1). The string [4mif-asked[24m causes pushes to be signed if the
           server supports it, as if [1m--signed=if-asked [22mis passed to [4mgit[24m [4mpush[24m.
       ...
       push.pushOption
           When no [1m--push-option=<option> [22margument is given from the command
           line, [1mgit push [22mbehaves as if each <value> of this variable is given
           as [1m--push-option=<value>[22m.

           This is a multi-valued variable, and an empty value can be used in
           a higher priority configuration file (e.g.  [1m.git/config [22min a
           repository) to clear the values inherited from a lower priority
           configuration files (e.g.  [1m$HOME/.gitconfig[22m).
       ...
       push.recurseSubmodules
           ...
           behavior as that of "push --recurse-submodules". If not set, [4mno[24m is
           used by default, unless [4msubmodule.recurse[24m is set (in which case a
           [4mtrue[24m value means [4mon-demand[24m).

       push.useForceIfIncludes
           If set to "true", it is equivalent to specifying
           [1m--force-if-includes [22mas an option to [1mgit-push[22m(1) in the command
           line. Adding [1m--no-force-if-includes [22mat the time of push overrides
       ...
       push.useBitmaps
           ...
           [1mpack.useBitmaps [22mis "true", without preventing other git operations
           from using bitmaps. Default is true.

[1mGIT[0m
       Part of the [1mgit[22m(1) suite

Git 2.43.0                        01/13/2025                       [4mGIT-PUSH[24m(1)
